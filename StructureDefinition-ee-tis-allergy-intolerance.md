...
| Draft as of 2026-01-20 | *Computable Name*:EETISAllergyIntolerance |
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-01-20T11:01:57+00:00",
  "publisher" : "TEHIK",
  "contact" : [
    {
      "name" : "TEHIK",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "Severity of the reaction. (ee Täheldatud reaktsiooni kliiniline tõsidus (nt kerge, mõõdukas, raske).",
        "binding" : {
          "strength" : "required",

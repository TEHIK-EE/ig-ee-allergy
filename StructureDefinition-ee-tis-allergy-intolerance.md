...
| Draft as of 2026-01-15 | *Computable Name*:EETISAllergyIntolerance |
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-01-15T10:36:22+00:00",
  "publisher" : "TEHIK",
  "contact" : [
    {
      "name" : "TEHIK",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "(ee Potentsiaalne risk tulevaste eluohutavate kõrvaltoimete tekkeks, kui inimene puutub kokku ainega, mis on teadaolevalt põhjustanud kõrvaltoimeid.)",
        "binding" : {
          "strength" : "required",
      ...
      },
      {
        ...
        "short" : "(ee Allergeenile vastav standardiseeritud kood. Kui allergeeni kood ei ole saadaval, peab allergeeni kirjeldus olema võimalikult täielik.)",
        "min" : 1,
        "binding" : {
          "strength" : "required",
      ...
      },
      {
        ...
        "short" : "(ee Aine kirjeldus, mis võib vallandada reaktsiooni. Kohustuslik ja võib korduda, kui kood pole piisav või on mitu kirjeldust.)"
      },
      {
      ...
      },
      {
        ...
        "short" : "(ee Muu asjakohane teave, mida ei saanud mujal struktureeritult esitada.)",
        "max" : "1"
      },
      {

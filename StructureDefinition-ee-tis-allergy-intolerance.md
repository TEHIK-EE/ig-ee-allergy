...
| Draft as of 2026-09-14 | *Computable Name*:EETISAllergyIntolerance |
...
* Examples for this Profile: [AllergyIntolerance/AllergyBiologic](AllergyIntolerance-AllergyBiologic.md), [AllergyIntolerance/AllergyEnvironment](AllergyIntolerance-AllergyEnvironment.md) and [AllergyIntolerance/AllergyFood](AllergyIntolerance-AllergyFood.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ig-ee-allergy|current/StructureDefinition/StructureDefinition-ee-tis-allergy-intolerance.json)
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-09-14T08:12:36+00:00",
  "publisher" : "TEHIK",
  "contact" : [{
    "name" : "TEHIK",
    "telecom" : [{

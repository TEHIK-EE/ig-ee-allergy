...
| Draft as of 2026-09-14 | *Computable Name*:EETISAllergyCondition |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ig-ee-allergy|current/StructureDefinition/StructureDefinition-ee-tis-allergy-condition.json)

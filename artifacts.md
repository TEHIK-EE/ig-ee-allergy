...
| [Grouper for reactions](StructureDefinition-ee-tis-allergy-reaction-grouper.md) | When there are more than one substance causing SAME reaction, these reactions are grouped together with this grouper. (ee Kui erinevatel toimeainetel on sama reaktsioon siis grupeeritakse kõik reaktsioonid selle laiendiga kokku.) |

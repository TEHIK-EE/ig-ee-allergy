# EE TIS AllergyIntolerance Medication - EE TIS Allergy IG v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **EE TIS AllergyIntolerance Medication**

## Resource Profile: EE TIS AllergyIntolerance Medication 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.ee/allergy/StructureDefinition/ee-tis-allergy-intolerance-medication | *Version*:0.1.0 |
| Draft as of 2026-04-09 | *Computable Name*:EETISAllergyIntoleranceMedication |

 
A profile for allergy and intolerance to medication. (ee Tervishoiutöötaja poolt registreeritav RAVIMI allergia.) 

**Usages:**

* Examples for this Profile: [AllergyIntolerance/AllergyMedication](AllergyIntolerance-AllergyMedication.md) and [AllergyIntolerance/AllergyMedicationFourSubstances](AllergyIntolerance-AllergyMedicationFourSubstances.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ig-ee-allergy|current/StructureDefinition/ee-tis-allergy-intolerance-medication)
...
Other representations of profile: [CSV](StructureDefinition-ee-tis-allergy-intolerance-medication.csv), [Excel](StructureDefinition-ee-tis-allergy-intolerance-medication.xlsx), [Schematron](StructureDefinition-ee-tis-allergy-intolerance-medication.sch) 
...
```json
{
  ...
  "id" : "ee-tis-allergy-intolerance-medication",
  "url" : "https://fhir.ee/allergy/StructureDefinition/ee-tis-allergy-intolerance-medication",
  "version" : "0.1.0",
  "name" : "EETISAllergyIntoleranceMedication",
  "title" : "EE TIS AllergyIntolerance Medication",
  "status" : "draft",
  "date" : "2026-04-09T06:23:36+00:00",
  "publisher" : "TEHIK",
  "contact" : [{
    "name" : "TEHIK",
    "telecom" : [{
  ...
  "description" : "A profile for allergy and intolerance to medication. (ee Tervishoiutöötaja poolt registreeritav RAVIMI allergia.)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "Allergy or intolerance if known. (ee Kirjeldab, kas seisund on allergia või talumatus. Kui eristus pole võimalik jääb see element TÜHJAKS)",
      "binding" : {
        "strength" : "required",
    ...
    },
    {
      ...
      "short" : "Code for medication allergy comes from ATC classification. (ee ATC EI OLE Terminoloogiaserveris, koodid valideeritakse läbi MedIni)",
      "min" : 1,
      "binding" : {
        "strength" : "required",
    ...
    },
    {
      ...
      "short" : "When SPD is published, reference must be to SPDPractitionerRole! (ee Kui SPD teenus valmib, peab viide olema sellele.)",
      "type" : [{
        "code" : "Reference",
    ...
    },
    {
      ...
      "short" : "diagnose is a reference to a Condition-extension which will be replaced in the future when Condition IG is ready and available. grouper is for grouping different substances with same reaction together."
    },
    {
      "id" : "AllergyIntolerance.reaction.extension:grouper",
      "path" : "AllergyIntolerance.reaction.extension",
      "sliceName" : "grouper",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.ee/allergy/StructureDefinition/ee-tis-allergy-reaction-grouper"]
      }]
    },
    {

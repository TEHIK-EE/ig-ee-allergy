...
* code.coding[=].code = #735215001
* code.coding[=].display = "Apple"
...
* reaction.manifestation.concept.coding.code = #81950002
* reaction.manifestation.concept.coding.display = "Keele turse"

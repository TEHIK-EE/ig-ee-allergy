Profile: EETISAllergyIntoleranceMedication
...
* note 0..1
* code ^short = "Allergy code from ATC classification. (ee ravimiallergeenile vastav standardiseeritud ATC-kood. Kui allergeeni kood ei ole saadaval, peab allergeeni kirjeldus olema võimalikult täielik.)"
* code 1..1
* code.id 0..0
* code.extension 0..0
* code.coding 0..1
...
* reaction.extension contains
    ExtensionEETISAllergyReactionGrouper named grouper 0..1 and
    ExtensionEETISAllergyDiagnosis named diagnose 0..1
* reaction.extension ^short = "diagnose is a reference to a Condition-extension which will be replaced in the future when Condition IG is ready and available. grouper is for grouping different substances with same reaction together."
...
* reaction.substance from $toimeained-VS

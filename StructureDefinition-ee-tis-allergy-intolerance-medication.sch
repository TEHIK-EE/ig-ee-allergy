...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:AllergyIntolerance/f:reaction">
      <sch:assert test="count(f:id) &lt;= 0">id: maximum cardinality of 'id' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/allergy/StructureDefinition/ee-tis-allergy-reaction-grouper']) &lt;= 1">extension with URL = 'https://fhir.ee/allergy/StructureDefinition/ee-tis-allergy-reaction-grouper': maximum cardinality of 'extension' is 1</sch:assert>
